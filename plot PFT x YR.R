...
df <- read.table("C:/R/2019_BQ/PFTdata_8pft.csv", header=T, sep=",")
...
tiff(file = "C:/R/2019_BQ/pft_x_yr.tiff", width = 2400, height = 4800, units = "px", res = 600, compression="lzw")
par(mfrow= c(3, 1))
...
y <- t(rbind(y1, y2, y3, y4, y7, y8))
x <- c(1, 5, 10, 20)

#tiff(file = "C:/R/2019_BQ/pft_x_yr_essf.tiff", 
#     width = 4650, height = 3000, units = "px", res = 600, compression="lzw")
#png(file = "C:/R/2019_BQ/pft_x_yr_essf.png", width = 3600, height = 2400, units = "px", res = 400)
ESSF =
  par(mar=c(0,3.85,0,0)+0.5)
plot.new()
plot.window(xlim=c(0,20), ylim=c(0, 80))
#axis(1)
axis(2)
...
plotchar <- c(24,21,21,22,22,8)
linetype <- c(1, 1, 1, 1, 1)
ptbackground <- c("black", "grey", "white", "grey", "white")

legend(
  x="topleft", y= null,
  c("PFT 1", "PFT 2", "PFT 3", "PFT 4", "PFT 7", "PFT 8"),
  cex=0.9, pch=plotchar, lty=linetype, col="black", pt.bg=ptbackground, pt.cex=1)
...
#tiff(file = "C:/R/2019_BQ/pft_x_yr_ich.tiff", 
#     width = 4650, height = 3000, units = "px", res = 600, compression="lzw")
#png(file = "C:/R/2019_BQ/pft_x_yr_ich.png", width = 3600, height = 2400, units = "px", res = 400)
...
#tiff(file = "C:/R/2019_BQ/pftxyr_sbs.tiff", 
#     width = 4650, height = 3000, units = "px", res = 600, compression="lzw")
#png(file = "C:/R/2019_BQ/pft_x_yr_sbs.png", width = 3600, height = 2400, units = "px", res = 400)
